...
1. What is the DOM?
    The DOM is Document Object Model - A javascript object containing every element in order on the page.

2. What is an event?
    An event is anything that happens within the browser, a click of the mouse, a push of a key, moving into an element or out of it.

3. What is an event listener?
    An event listener detects events and can perform a specific task or set of tasks. 
